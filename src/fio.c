...
action_type_t getActionTypeByContractAccountName(network_type_t network,
                                                 uint8_t *contractAccountName,
                                                 size_t length) {
    ASSERT(length == CONTRACT_ACCOUNT_NAME_LENGTH);
    const uint8_t trnsfiopubky[CONTRACT_ACCOUNT_NAME_LENGTH] = {0x00,
                                                                0x00,
                                                                0x98,
                                                                0x0a,
                                                                0xd2,
