...
__noinline_due_to_stack__ void ui_displayPathScreen(const char* screenHeader,
    ...
    ui_displayPaginatedText(screenHeader, pathStr, callback);
}
...
__noinline_due_to_stack__ void ui_displayFIOAmountScreen(const char* screenHeader,
                                                         uint64_t amount,
                                                         ui_callback_fn_t callback) {
...
__noinline_due_to_stack__ void ui_displayHexBufferScreen(const char* screenHeader,
    ...
    ui_displayPaginatedText(screenHeader, bufferHex, callback);
}

__noinline_due_to_stack__ void ui_displayPubkeyScreen(const char* screenHeader,
