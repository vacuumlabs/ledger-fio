...
#define TESTCASE(path_, outputSize_, expected_)                             \
    ...
    TESTCASE((1, 2, 3, 4, 5, 6, 7), BIP44_MAX_PATH_STRING_LENGTH, "m/1/2/3/4/5/6/7");
    TESTCASE((1, 2, 3, 4, 5, 6, 7), 16, "m/1/2/3/4/5/6/7");
    TESTCASE((), 2, "m");
    TESTCASE((HD + 44, HD + 1815, HD + 0, 1, 55),
             BIP44_MAX_PATH_STRING_LENGTH,
             "m/44'/1815'/0'/1/55");
    TESTCASE((HD + 44, HD + 1815), 100, "m/44'/1815'");
#undef TESTCASE
}
