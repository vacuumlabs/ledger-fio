...
extern unsigned char const C_icon_left_bitmap[4];
        ...
        #endif // HAVE_BAGL
#ifndef GLYPH_icon_loader_BPP
        #define GLYPH_icon_loader_WIDTH 14
        #define GLYPH_icon_loader_HEIGHT 14
        #define GLYPH_icon_loader_BPP 1
extern unsigned int const C_icon_loader_colors[];
extern unsigned char const C_icon_loader_bitmap[25];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_icon_loader;
        #endif // GLYPH_icon_loader_BPP
        #endif // HAVE_BAGL
