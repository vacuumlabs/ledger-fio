...
async function buildTxAndSignatureFioJs(network, tx, pubkey) {
    ...
    // Get the addnft action type
    const actionAddnft = networkInfo[network].typesTransaction2.get('addnft')
    ...
    actionAddnft.serialize(buffer, tx.actions[0].data)
